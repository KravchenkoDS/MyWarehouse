...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { description: @partner.description, title: @partner.title } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { description: @partner.description, title: @partner.title } }
