...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference('Shipment.count') do
      post shipments_url, params: { shipment: { comment: @shipment.comment, count: @shipment.count, moving: @shipment.moving, price: @shipment.price, product: @shipment.product } }
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { comment: @shipment.comment, count: @shipment.count, moving: @shipment.moving, price: @shipment.price, product: @shipment.product } }
